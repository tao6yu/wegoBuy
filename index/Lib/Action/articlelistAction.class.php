...
class articlelistAction extends baseAction
{
	public function index()
	{
    	...
    	//显示配置seo信息
    	$this->seo['seo_title'] = !empty($cate_info['seo_title']) ? $cate_info['seo_title'] : $cate_info['title'];
	    $this->seo['seo_title'] = $this->seo['seo_title'] . ' - ' . $this->setting['site_name'];
	    $this->seo['seo_keys'] = !empty($cate_info['seo_keys']) ? $cate_info['seo_keys'] : $cate_info['title'];
	    $cate_info['seo_desc'] && $this->seo['seo_desc'] = $cate_info['seo_desc']; 	    
